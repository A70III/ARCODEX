...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div
        class="flex items-center justify-between px-2 py-1 hover:bg-[var(--bg-hover)] group"
      >
        <div
      ...
      <div class="flex items-center gap-1 px-2 py-1 ml-4">
        <span
          class="material-icons text-base"
          [class.text-[var(--warning)]]="creatingType() === 'folder'"
          [class.text-[var(--info)]]="creatingType() === 'file'"
        >
      ...
      >
        <span class="material-icons text-5xl text-[var(--border-color)] mb-4"
          >folder_open</span
        >
      ...
      <!-- Chapters View -->
      @if (projectState.activeSidebarView() === 'chapters') {
      <app-chapters class="flex-1 overflow-hidden" />
      }
    </div>
